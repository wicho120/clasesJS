...
export const getAllMadridClientsCodeSalesManager11_30 = async() => {
    ...
    let res = await fetch("http://176.16.101.146:5741/clients?city=Madrid")
...
export const getNamesAllClientsBySpain = async() => {
    let res = await fetch("http://176.16.101.146:5741/clients?country=Spain")
    let data = await res.json();
...
export const getAllClientsNameSalesManagerOffice = async () => {
    let res = await fetch("http://176.16.101.146:5741/clients");
    let data = await res.json();
    let dataUpdate = [];
